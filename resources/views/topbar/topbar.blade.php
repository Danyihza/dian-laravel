            ...
            <div class="search-result__content">
                ...
                <div class="mb-5">
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                                src="{{ asset('assets') }}/images/profile-11.jpg">
                        </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                                src="{{ asset('assets') }}/images/profile-13.jpg">
                        </div>
                        <div class="ml-3">Tom Cruise</div>
                        <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">
                            tomcruise@left4code.com</div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                            src="{{ asset('assets') }}/images/preview-13.jpg">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                            src="{{ asset('assets') }}/images/preview-11.jpg">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                            src="{{ asset('assets') }}/images/preview-5.jpg">
                    </div>
            ...
            <div class="notification-content__box dropdown-box__content box dark:bg-dark-6">
                ...
                <div class="cursor-pointer relative flex items-center ">
                    ...
                    <div class="ml-2 overflow-hidden">
                        ...
                        <div class="w-full truncate text-gray-600">Lorem Ipsum is simply dummy text of
                ...
                <div class="cursor-pointer relative flex items-center mt-5">
                    ...
                    <div class="ml-2 overflow-hidden">
                        ...
                        <div class="w-full truncate text-gray-600">Contrary to popular belief, Lorem
                ...
                <div class="cursor-pointer relative flex items-center mt-5">
                    <div class="w-12 h-12 flex-none image-fit mr-1">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full"
                            src="{{ asset('assets') }}/images/profile-5.jpg">
                        <div
                            class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white">
                        </div>
                    </div>
