            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="Midone Tailwind HTML Admin Template" class="w-6" src="{{ asset('assets') }}/images/dian-logo.png">
                        <span class="text-white text-lg ml-3"> MAIS - Dian Institute </span>
                    </a>
                    <div class="my-auto">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        <h2 class="mb-5 intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                            Sign In
                        </h2>
                        ...
                        <div class="intro-x mt-8">
                                <form action="{{ route('signin') }}" method="post">
                                    @csrf
                                <input type="text" class="intro-x login__input input input--lg border border-gray-300 block" name="username" placeholder="Username Admin">
